...
/**
 * This class will contain various static methods which exist as sample solutions to particular problems.
 * They're not necessarily the most polished code, but sometimes it's easier to explain with code than in
 * plain text.
 */
